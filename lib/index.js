...
const xy = (padre, cfg = cfgDefault, aspectRatio = 16 / 9) => {
  ...
  const svg = Object(_tools_js__WEBPACK_IMPORTED_MODULE_1__["construyeSVG"])(_xy_scss__WEBPACK_IMPORTED_MODULE_0___default.a, undefined, undefined, w, h);
...
// module
exports.push([module.i, "text.titulo_abcisa {\n  text-anchor: start;\n  font-size: 25px;\n  font-family: Verdana, Geneva, Tahoma, sans-serif;\n  fill: #333; }\n\n.axis {\n  stroke: #333; }\n  .axis text {\n    text-anchor: middle;\n    fill: #333;\n    font-family: Verdana, Geneva, Tahoma, sans-serif;\n    font-size: 18px; }\n    .axis text.abcisa {\n      text-anchor: end; }\n  .axis path.grafica, .axis use.cir {\n    stroke: chocolate;\n    stroke-width: 4px;\n    fill: none; }\n", ""]);
